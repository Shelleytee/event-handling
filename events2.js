...
one.addEventListener("mouseenter", colourMe);
two.addEventListener("mouseenter", colourMe);
three.addEventListener("mouseenter", colourMe);
four.addEventListener("click", colourMe);

function colourMe() {

var colourMe = this.attributes["data-colour"].value;

  this.addEventListener('mouseenter', makeGreen)
  this.addEventListener('mouseleave', makeWhite)
